  ...
  return (
   <div className="flex justify-center items-center min-h-screen  ">
    ...
    <div className="card bg-base-100 w-[94%]  md:w-100 shrink-0 shadow-2xl   ">
         ...
         <h1 className="text-xl md:text-3xl font-bold  pt-5 text-center">Login Your Account</h1>
    ...
    className=" btn-ghost btn-lg absolute right-3 top-9 transform -translate-y-1/2 text-gray-500 z-3">{
      showPassword? (<PiEyeClosed size={25} />):(<BsEyeglasses size={25} />)
          ...
          <button type='submit' className="btn bg-[#2bb958] mt-4">Login</button>
          <p className='font-semibold text-center pt-3'>Don't have an account? 
            <Link to="/auth/register" state={location.state}className='text-red-600'> Register </Link>
          </p>
          {/* google */}
